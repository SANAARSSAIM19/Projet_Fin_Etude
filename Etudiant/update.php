...
if(isset($_POST['submit'])){
    $sql2="UPDATE etudiant  SET  ID_FILIERE_ = ?,NOM_USER = ?
    ,PRENOM_USER = ?,DATEN_USER = ?,CIN_USER = ?,EMAIL_USER = ?
    ,PASSWORD_USER = ?,ADRESSE_USER = ?,TELE_USER = ?,SEXE_USER = ?
    ,ADRESS_PARENTIELLE_ET = ?,NIVEAU_ET = ?  WHERE ID_ADMIN = ?";
    ...
    $rs_modif->bindValue(8,$TELE_USER,PDO::PARAM_INT);
    $rs_modif->bindValue(9,$SEXE_USER,PDO::PARAM_STR);
    $rs_modif->bindValue(10,$CNE_ET,PDO::PARAM_STR);
